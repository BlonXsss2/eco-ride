...
// petit script pour remplir la BDD (Fly ou local)
...
// remplit users, vehicles et trajets si besoin
function runSeed() {
    $pdo = null;
    ...
    try {
        ...
        // trajets futurs pour les recherches classiques
        $routes = [
...
// lance le script en ligne de commande
